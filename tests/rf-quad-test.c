  ...
  for (i = 0; i < nexec; i++) 
    {
      ...
      test_rf_quad (seed, rf_quad_params1);
    }
  for (i = 0; i < nexec; i++)
    {
      bytes_urandom (seed, sizeof (seed));
      test_rf_quad (seed, rf_quad_params2);
    }
  for (i = 0; i < nexec; i++)
    {
      bytes_urandom (seed, sizeof (seed));
      test_rf_quad (seed, rf_quad_params3);
    }
  for (i = 0; i < nexec; i++)
    {
      bytes_urandom (seed, sizeof (seed));
      test_rf_quad (seed, rf_quad_params4);
    }
  for (i = 0; i < nexec; i++)
    {
      bytes_urandom (seed, sizeof (seed));
      test_rf_quad (seed, rf_quad_params5);
    }
  TEST_PASS ();
}
