...
} rf_abdlop_params_struct;
typedef rf_abdlop_params_struct rf_abdlop_params_t[1];
typedef rf_abdlop_params_struct *rf_abdlop_params_ptr;
typedef const rf_abdlop_params_struct *rf_abdlop_params_srcptr;

typedef struct
{
  const rf_abdlop_params_srcptr quad_eval;
  const rf_abdlop_params_srcptr quad_many;
  const unsigned int lambda;

} rf_quad_eval_params_struct;
typedef rf_quad_eval_params_struct rf_quad_eval_params_t[1];
typedef rf_quad_eval_params_struct *rf_quad_eval_params_ptr;
typedef const rf_quad_eval_params_struct *rf_quad_eval_params_srcptr;
...
void rf_abdlop_keygen (polymat_t A1, polymat_t A2prime, polymat_t Bprime,
               const uint8_t seed[32], const rf_abdlop_params_t params);

void rf_abdlop_commit (polyvec_t tA1, polyvec_t tA2, polyvec_t tB, polyvec_t s1, polyvec_t rand_enc_s1,
...
void rf_abdlop_enccomm (uint8_t *buf, size_t *buflen, polyvec_t tA1, polyvec_t tB, const rf_abdlop_params_t params);

void rf_abdlop_hashcomm (uint8_t hash[32], polyvec_t tA1, polyvec_t tB,
                 const rf_abdlop_params_t params);

void rf_abdlop_prove (uint8_t hash[32], poly_t c, polyvec_t z1, polyvec_t z21,
              polyvec_t h, polyvec_t tA2, polyvec_t rand_enc_s1, polyvec_t s2,
              polymat_t A1, polymat_t A2prime, const uint8_t seed[32],
              const rf_abdlop_params_t params);

int rf_abdlop_verify (uint8_t hash[32], poly_t c, polyvec_t z1, polyvec_t z21,
              polyvec_t h, polyvec_t tA1, polymat_t A1, polymat_t A2prime,
              const rf_abdlop_params_t params);

void rf_quad_prove (uint8_t hash[32], polyvec_t tB, poly_t c, polyvec_t z1,
              ...
              const rf_abdlop_params_t params);
int rf_quad_verify (uint8_t hash[32], poly_t c, polyvec_t z1, polyvec_t z21,
                     polyvec_t h, polyvec_t tA1, polyvec_t tB, polymat_t A1,
                     polymat_t A2prime, polymat_t Bprime, spolymat_t R2,
                     spolyvec_t r1, poly_t r0, const rf_abdlop_params_t params);

void rf_quad_many_prove (uint8_t hash[32], polyvec_t tB, poly_t c,
                          ...
                          const rf_abdlop_params_t params);
int rf_quad_many_verify (uint8_t hash[32], poly_t c, polyvec_t z1,
...
void rf_quad_eval_prove (uint8_t hash[32], polyvec_t tB, polyvec_t h,
...
int rf_quad_eval_verify (uint8_t hash[32], polyvec_t h, poly_t c,
...
void print_stopwatch_rf_quad_eval_prove (unsigned int indent);
void print_stopwatch_rf_quad_eval_verify (unsigned int indent);
void print_stopwatch_rf_quad_many_prove (unsigned int indent);
void print_stopwatch_rf_quad_many_verify (unsigned int indent);
void print_stopwatch_rf_quad_prove (unsigned int indent);
void print_stopwatch_rf_quad_verify (unsigned int indent);
